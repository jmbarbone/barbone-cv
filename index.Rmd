...
bibliography_posters_cog: "bib/posters_cog.bib"
---
...
bib <- read_bib_utf8(bib_file)

# bib <- mark::read_bib(bib_file)
...
posters %>%
  ...
  RefManageR::as.BibEntry() %>%
  RefManageR::WriteBib(file = "bib/posters_cog.bib")
```
